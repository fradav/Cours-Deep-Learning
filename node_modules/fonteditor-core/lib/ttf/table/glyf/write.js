  ...
  ttf.glyf.forEach(function (glyf, index) {
    ...
    if (glyf.compound) {
      for (i = 0, l = glyf.glyfs.length; i < l; i++) {
        flags = _componentFlag["default"].ARGS_ARE_XY_VALUES + _componentFlag["default"].ROUND_XY_TO_GRID; // xy values
        // more components
        ...
        var g = glyf.glyfs[i]; // use my metrics

        flags += g.useMyMetrics ? _componentFlag["default"].USE_MY_METRICS : 0; // overlap compound
        ...
        var d = transform.d;
        var e = transform.e;
        var f = transform.f; // xy values or points
        // int 8 放不下，则用int16放
